...
<div class="form">
    ...
    <form action="/extras" method="post" id="extras" on:submit|preventDefault={save}>
        ...
        <h4>Config Switch:</h4>
        <p><label>Config Switch pin type:<br /><select name="switch_cfg_type" bind:value={$extras.switch_cfg_type}><option disabled selected hidden>Pullup</option><option value="0">Pullup</option><option value="1">Pullup Inverted</option><option value="2">Pulldown</option><option value="3">Pulldown Inverted</option><option value="4">Floating</option><option value="5">Floating Inverted</option></select></label></p>
        <p><label>Config Switch pin (-1 for disable):<br /><input type="number" step="1" name="switch_cfg_pin" placeholder="-1" bind:value={$extras.switch_cfg_pin}/></label></p>
        <h4>Switch One:</h4>
